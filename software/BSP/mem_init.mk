...
MEM_2 := nios_system_packet_memory
$(MEM_2)_NAME := packet_memory
...
$(MEM_2)_START := 0x08201000
$(MEM_2)_END := 0x08201fff
$(MEM_2)_HIERARCHICAL_PATH := packet_memory
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: packet_memory
packet_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
